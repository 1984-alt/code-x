...
- `plugins/code-x/skills/code-x/checkers/` — `cx` CLI, `check-contracts.yaml` (404 clauses), `tests/`
...
python3 checkers/tests/run.py             # 424 unit self-tests
python3 checkers/tests/run_contracts.py   # 404 gate clauses each proven to bite
