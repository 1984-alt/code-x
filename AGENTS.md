...
- `plugins/code-x/skills/code-x/checkers/` — `cx` CLI, `check-contracts.yaml` (392 clauses), `tests/`
...
python3 checkers/tests/run.py             # 411 unit self-tests
python3 checkers/tests/run_contracts.py   # 392 gate clauses each proven to bite
