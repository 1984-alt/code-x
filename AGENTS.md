...
- `plugins/code-x/skills/code-x/checkers/` — `cx` CLI, `check-contracts.yaml` (488 clauses), `tests/`
...
python3 checkers/tests/run.py             # 597 unit self-tests
python3 checkers/tests/run_contracts.py   # 488 gate clauses each proven to bite
