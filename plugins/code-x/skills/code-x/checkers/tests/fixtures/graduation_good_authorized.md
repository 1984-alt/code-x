# Test fixture — graduation ledger: SAME 3 clean projects as graduation_good.md.
# Used with --authorize-decision against graduation_decision_ledger_authorized.md — the
# streak (3) satisfies N=3/M=3, no pending-newer entry, decision marker present -> PASS.
