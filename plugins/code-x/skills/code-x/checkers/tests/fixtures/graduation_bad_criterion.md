# Test fixture — proj-gamma's c2 hash-binds correctly but its demo-attempt-history shows
# attempt #1 = needs_fix, attempt #2 = accepted -> NOT accepted on the FIRST demo. Proves the
# recompute is real field re-derivation, not a hash-only pass. GRADUATION-ENTRY-CRITERION-UNMET P1.
