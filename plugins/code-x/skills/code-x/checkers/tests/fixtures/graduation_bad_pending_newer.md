# Test fixture — 3 historical clean (closed windows) + proj-delta NEWEST with an OPEN c5
# post-ship window (ship_date 2026-06-25, window closes 2026-07-09, 'today' is 2026-07-01) —
# every other criterion MET, so proj-delta is PENDING, not clean. Authorizing while the most
# recent work is unproven is blocked. GRADUATION-STREAK-UNPROVEN P0 (pending-newer, R1.1.3).
...
- project_id: proj-delta
  ship_commit: ce2c32e5b1e7ddf5da9b024fb5f6d6426f524272
  ship_date: 2026-06-25
  ship_timestamp_utc: "2026-06-25T10:00:00Z"
  entered_by: hand-append
  evidence_manifest: graduation_receipts/clean/graduation-evidence-manifest.yaml
  risk_tier: STANDARD
  tier_evidence: {receipt: graduation_receipts/clean/tier-standard.yaml, receipt_sha256: e750d7cd467245edee8660a769076cc046090068d3a87e79661324af943675a0}
