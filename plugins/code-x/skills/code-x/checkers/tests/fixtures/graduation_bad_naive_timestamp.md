# Test fixture (R2.6/R2.8) — proj-gamma's ship_timestamp_utc has NO timezone offset (naive) —
# rejected, never silently assumed UTC (a naive/aware mix is exactly what used to raise an
# uncaught TypeError during the streak sort). GRADUATION-ENTRY-SHAPE P1.
...
- project_id: proj-gamma
  ...
  ship_timestamp_utc: "2026-03-01T10:00:00"
  entered_by: hand-append
  evidence_manifest: graduation_receipts/clean/graduation-evidence-manifest.yaml
  criteria:
    c1_demo_gate_never_fired: {receipt: graduation_receipts/clean/c1-index.yaml, receipt_sha256: 2015b253a72f442a2921eb1a528673b2219f82487a6745cc3a5829de4cdd856a}
