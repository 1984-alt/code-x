# Test fixture — PBF-PROP-019 Phase 4: proj-gamma (newest) carries NO risk_tier / tier_evidence
# fields at all — an entry may never be silent on tier. FAIL-CLOSED DIRECTION IS THE OPPOSITE of
# the packet default (cx_common.resolve_risk_tier defaults absence to STRICT): here, missing tier
# evidence is REJECTED from the streak (P0), never defaulted to STRICT-and-counted.
