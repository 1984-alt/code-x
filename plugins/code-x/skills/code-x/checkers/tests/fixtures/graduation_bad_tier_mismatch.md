# Test fixture — PBF-PROP-019 Phase 4 (design v2 P1-5, LITE->STANDARD migration guard):
# proj-gamma (newest) declares risk_tier: STANDARD but its hash-bound tier_evidence receipt
# (graduation_receipts/clean/tier-lite.yaml, correctly bound — real file, matching manifest hash)
# asserts the frozen packet actually resolved to LITE. A later tier claim can never retroactively
# bank a run that was actually built under a lighter tier. GRADUATION-TIER-EVIDENCE-REQUIRED P0.
