...
|---|---|---|---|
| **P0** | Danger — destruction, secret/privacy leak, data loss, public exposure, unsafe/illegal action | secret leaked · app writes live-production data when forbidden · destructive restore with no backup | **STOP NOW** |
